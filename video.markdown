...
This is a collection of various videos I've created using a plethora of diffusion models (mostly image models).<br>
This were made around 2023 mostly so animation quality isn't the same as latest models, but they do are trippy.
