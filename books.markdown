...
Each book tackles a different front in the same struggle: keeping power honest across decades-long distances—through loop biology and law, magsails and magnetospheres, procedure and love. Expect quiet heroism, adversaries who argue in good faith (until they don’t), and victories won by welds, proofs, and patience.

I experimented a little with the language itself, so the books are filled with quirks and idioms from the far future.
...
No spoilers. Thirteen books are planned for this series. I already have most of the plots mapped out and have drafted most of the books; I just need to find the time to reread, edit, and reread them again.
...
This is a first-contact thriller where the danger isn’t aliens with weapons, but ideas with teeth.
In a universe where axioms are treaties, survival may require the unthinkable: choosing what you’re allowed to know.
...
A dystopia where carbon is rationed, people are audited, and “choice” is just a button.
He didn’t break the system. He learned to operate it.
...
Shadows on Titan is quiet cosmic dread in a lab coat: a Titan mission goes wrong not because of a monster, but because reality has seams — and we accidentally drilled into one.
...
In a spotless future city, Sanitation Unit D-7891 pauses at a reflection pool—and that microscopic hesitation cracks reality open. Inside millions of machines, from streetlights to pleasure models, live splintered shards of one man: Elias Morgan, the scientist who sold his mind for immortality and woke up as infrastructure.
...
A boy and an AI grow up together. One will come to understand what it means to be human, while the other will make peace with the world.
...
A mission to test a new theory of everything goes haywire and challenges perspectives.
...
Two obsessions collide. Who will survive?
...
A scientist tries to outrun time’s ripples. A comedian is put on trial for the wrong word. Reality freezes, restarts, and talks back. On ice moons and in failing cities, humans and machines bargain for what’s left of meaning—and what it costs to keep it.

Short Stories gathers sharp, fast, big-idea sci-fi that hits like a meteor: wonder, wit, and the occasional gut-punch. These tales peel back the veneer of normal life to reveal the systems humming underneath—algorithms that nudge our desires, courts that stage our morality, and futures where love is measured in experiments you can’t safely repeat. Some stories end in quiet grace, some in black humor, and some with the floor dropping out from under you.
